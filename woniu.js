...
--*/
		L_B += "<li class=\"active\"><a href=\"#panel-666\"data-toggle=\"tab\"contenteditable=\"false\" style=\"padding: 4px 1px;\">导航</a></li><li class=\"\"><a href=\"#panel-998\"data-toggle=\"tab\"contenteditable=\"false\" style=\"padding: 4px 1px;\">博客</a></li><li class=\"\"><a href=\"#panel-999\"data-toggle=\"tab\"contenteditable=\"false\" style=\"padding: 4px 1px;\">留言</a></li></ul><div class=\"tab-content\"> <div class=\"tab-pane active\"id=\"panel-666\">"+ZY_ECHOS(J_00,''+ZY_DATA(dh_j,'XX','666')+'','66600')+"</div><div class=\"tab-pane\"id=\"panel-998\"><div class=\"text-center\"><a class=\"btn btn-default\" href=\"https://support.qq.com/products/336415/blog-archive\" target=\"_Blank\">点击访问-蜗牛腾讯兔小巢博客</a></div></div><div class=\"tab-pane\"id=\"panel-999\"><div class=\"text-center\"><a class=\"btn btn-default\" href=\"https://support.qq.com/embed/phone/336415?\" target=\"_Blank\">点击访问-腾讯兔小巢-给我留言反馈</a></div></div></div></div></div>";
...
function PNGS(lid) {
    ...
    $.ajax({
        ...
        async: true,
        type: "GET",
        url: '//tools.sixyin.com/zaixianbizhi/api.php',
...
*/
	var sjxjjlb = '[';
	for(var i=0;i<=100;i++){
		sjxjjlb += '{m4v:"http://v.nrzj.vip/video.php?_t=' + TIME('T') + i + '",title:"' + i + '"},';
	}
...
setTimeout(function(){init();$(".DH_KG").show();$(".GS_KG").hide();$(".JP_KG").hide();$("#UUUU_P").remove();$("#UUUU_PG").remove();}, 500);
